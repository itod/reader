...
- (void)viewDidLoad {
    ...
    self.stories = @[
                     ...
                     [parser parseString:@"G is for (Glasses)[glasses];" error:nil],
                     ...
                     [parser parseString:@"G is for (Geese)[geese];" error:nil],
                     [parser parseString:@"F is for (Farm)[farm];" error:nil],
                     ...
                     [parser parseString:@"C is for (Couch)[couch];" error:nil],
                     ...
                     [parser parseString:@"T is for (Teddy bear)[Teddy bear];" error:nil],
