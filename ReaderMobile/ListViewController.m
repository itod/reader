...
//                     [parser parseString:@"(die Spielerin)[soccer_girl];" error:nil],
                     ...
                     [parser parseString:@"L is for (Label)[label];" error:nil],
                     ...
                     [parser parseString:@"B is for (Bike)[bike];" error:nil],
                     ...
                     [parser parseString:@"P is for (Phone)[phone];" error:nil],
                     ...
                     [parser parseString:@"R is for (Redphone)[redphone];" error:nil],
                     ...
                     [parser parseString:@"C is for (Capuchin4)[capuchin4];" error:nil],
                     [parser parseString:@"R is for (Regular Tie)[neck_tie];" error:nil],
                     ...
                     [parser parseString:@"T is for (Tv)[tv];" error:nil],
